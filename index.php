    ...
    <div class="intro-container">
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo get_template_directory_uri(); ?>/img/intro-carousel/5.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
    ...
    <section id="testimonials" class="section-bg wow fadeInUp">
      <div class="container">
        ...
        <div class="owl-carousel testimonials-carousel">
          ...
          <div class="testimonial-item">
            <img src="<?php echo get_template_directory_uri(); ?>/img/testimonial-5.jpg" class="testimonial-img" alt="">
            <h3>John Larson</h3>
            <h4>Entrepreneur</h4>
            <p>
              <img src="<?php echo get_template_directory_uri(); ?>/img/quote-sign-left.png" class="quote-sign-left" alt="">
